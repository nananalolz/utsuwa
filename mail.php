...
$site_top = "http://ohagiohagi.pupu.jp/utsuwa/index.html";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "bepona12@yahoo.co.jp";
...
$thanksPage = "http://ohagiohagi.pupu.jp/utsuwa/thanks.html";
